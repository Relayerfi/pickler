...
const children = [
  spawn(process.execPath, ['--import', 'tsx', 'src/workers/main.ts'], { stdio: 'inherit', env: { ...process.env, MASTRA_TELEMETRY_DISABLED: '1' } }),
  spawn('mastra', [mode], { stdio: 'inherit', env: { ...process.env, MASTRA_TELEMETRY_DISABLED: '1' } }),
];
let stopping = false;
